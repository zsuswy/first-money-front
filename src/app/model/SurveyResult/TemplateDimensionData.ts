...
export class TemplateDimensionData {
    constructor(public sumData?: any,                                                       // 汇总图表数据
                ...
                public subDimensionScoreListForInfo?: SurveyResultDimensionScore[],         // 过滤后，为描述信息显示的子维度得分
                public subDimensionScoreListForChart?: SurveyResultDimensionScore[]         // 过滤后，为图表显示的子维度得分
    ) {
    };
}